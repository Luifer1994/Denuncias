        ...
        <tr>
            <th style="text-align: left; padding-left: 10px;">
                <p style="margin-top: 2px;margin-bottom: 2px;">
                    Te informamos que quedan 12 horas para asignar la denuncia registrada con código
                    <span style="font-weight: bold; font-size:14px">{{ $msg['cod'] }}</span> a algún técnico.
                </p>
                <br>
